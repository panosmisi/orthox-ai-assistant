...
def attempt_load(weights, device=None, inplace=True, fuse=True):
    ...
    for w in weights if isinstance(weights, list) else [weights]:
        # YOLOv9 checkpoints in this project are trusted local full-model
        # checkpoints. PyTorch 2.6 defaults to weights_only=True, which blocks
        # loading these legacy serialized model objects unless we opt out.
